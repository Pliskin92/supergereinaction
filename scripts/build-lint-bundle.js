...
const bundles = {
  ...
  'bundle.js': ['canvas-fit.js', 'i18n.js', 'highscores.js', 'campaign.js', 'title.js', 'game.js', 'touch.js'],
  // web/arena/index.html
  // web/level/index.html
  'bundle-level.js': [
    'canvas-fit.js', 'i18n.js', 'sprites.js', 'sprite-manifest.js', 'assets.js', 'entities.js',
    'fury-hud.js', 'highscores.js', 'campaign.js', 'intro.js', 'level-card.js',
    'interlude.js', 'assist.js', 'shop.js', 'lockcode.js', 'level.js', 'touch.js',
  ],
  'bundle-arena.js': [
    'canvas-fit.js', 'i18n.js', 'sprites.js', 'sprite-manifest.js', 'assets.js', 'entities.js',
    'stages.js', 'fury-hud.js', 'char-arena.js', 'touch.js',
  ],
};
